...
public class Q6 {
	...
	public static void execute() throws Exception {
		...
		// Text entry shall contain thou or thee or thy (match) --> match does this work
		query.must(QueryBuilders.matchQuery("text_entry","thou thee thy"));

		// Play_name shall be Romeo and Juliet
		query.filter(QueryBuilders.termQuery("play_name","Hamlet"));

		//The relevance score of each document is represented by a positive
		// floating-point number called the _score. The higher the _score, the more relevant the document.
