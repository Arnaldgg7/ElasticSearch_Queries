...
public class Q7 {
	...
	public static void execute() throws Exception {
		...
		SearchResponse response = client.prepareSearch("shakespeare")
				...
				.setQuery(QueryBuilders.matchQuery("text_entry","love"))
				.addAggregation(AggregationBuilders.terms("agg1").field("speaker").order(BucketOrder.count(false)).size(Utils.MAX_RESULTS))
